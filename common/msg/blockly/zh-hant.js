...
ZhHans.MIXLY_ESP32_EXTERN_NEAR = "紅外接近感測器";
...
ZhHant.MIXLY_CI130X_GET_THE_RECOGNIZED_STATE_TOOLTIP = '返回（是否被喚醒，是否在播報）元組，用[0],[1]索取對應的';
...
ZhHant.MIXLY_CAR = '小車';
ZhHant.MIXLY_LIGHT_SENSOR = '光敏傳感器';
ZhHant.MIXLY_BODY_SENSOR = '人體感應傳感器';
ZhHant.MIXLY_SOILHUM_SENSOR = '土壤濕度傳感器';
ZhHant.MIXLY_GYROSCOPE_SENSOR = '陀螺儀傳感器';
ZhHant.MIXLY_Horizontal_inclination = '水平方向傾斜度';
ZhHant.MIXLY_Infrared_pyroelectric_sensor = '紅外熱釋電傳感器';
